...
import negyedikHaziPcg.Mezo.Allapot;
import negyedikHaziPcg.Vevo.VevoIdentity;

public class MestersegesIntelligencia {
	private int N = 0;
	...
	public MestersegesIntelligencia(int[] hajokKiosztasa, int N) {
		this.N = N;
